...
export const scenes: Scene[] = [
  ...
  },
  {
    ...
    layer: "quark",
    durationSeconds: 15, // VO 14.3s→~12.8s after trimming one clause + ~2s room
    keyframePrompt:
