...
export const scenes: Scene[] = [
  ...
  },
  {
    ...
    motionPrompt:
      "0–2s: the red-rejected block tumbles away and the validator web's nodes go dark behind us as the camera turns to the valid gold block still glowing green and crash zooms through its surface — warp-tunnel streaks rush past. 2–8s: the streaks fall back to the frame edges and a single transaction atom arrives at center, resolving into a precise atomic diagram; it rotates and its shells separate into labeled orbits — nucleus (version, locktime), left electrons (inputs), right electrons (outputs). 8–12s: gentle orbital rotation as the atom settles and the labels come to rest.",
