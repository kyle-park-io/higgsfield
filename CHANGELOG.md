...
- New **`quantum-entanglement`** project — same 9-scene guide & 21:9 format as the Bitcoin project,
  re-based on a new reference video (`projects/quantum-entanglement/references/…mp4`) as its visual
  base. Started as a copy of the Bitcoin `scenes.ts`.
