...
export const production = {
  ...
  styleTags:
    "dark cosmic void, bioluminescent particles, translucent 3D structures, volumetric glow, scientific visualization, high detail, cinematic, 2.35:1",
...
export const scenes: Scene[] = [
  {
    ...
    layer: "molecule",
    keyframePrompt:
      "Dark cosmic void, dozens of small glowing atom-like transaction particles of varying sizes floating, cool cyan-white light; some particles show 1 input + 2 outputs, others many inputs/outputs; one unique bright gold particle with distinct geometry (coinbase), volumetric fog, scientific visualization, 2.35:1",
    motionPrompt:
  ...
  },
  {
    ...
    layer: "molecule",
    keyframePrompt:
      "A completed amber molecular block with a glowing crystalline block-header nucleus at its center, a beam of light extending from the nucleus toward a previous block, a chain of linked blocks receding into dark space, 2.35:1",
    motionPrompt:
  ...
  },
  {
    ...
    layer: "molecule",
    keyframePrompt:
      "A glowing amber block molecule passing before multiple identical node-scanner devices arranged around it in a dark lab-like void, each scanner projecting a thin scanning grid onto the block, 2.35:1",
    motionPrompt:
  ...
  },
  {
    ...
    layer: "atom",
    keyframePrompt:
      'Extreme close-up inside a block molecule; a single glowing transaction atom at center, its structure separated into orbital shells — central nucleus labeled "version / locktime", left orbit "inputs (prev txid, vout, sequence, scriptSig/witness)", right orbit "outputs (amount, scriptPubKey)"; clean atomic diagram, cyan glow, 2.35:1',
    motionPrompt:
  ...
  },
  {
    ...
    layer: "atom",
    keyframePrompt:
      'A bright glowing output atom labeled "UTXO A / Alice"; a reaching input arm from a new transaction pointing at it; a red "SPENT" seal forming on UTXO A; a newly crystallizing "UTXO B / Bob"; a smaller "change" UTXO returning toward Alice; dark void, 2.35:1',
    motionPrompt:
  ...
  },
  {
    ...
    layer: "atom",
    keyframePrompt:
      "Several transaction atoms connected like a chemical reaction diagram; glowing arrows from one tx's outputs into the next tx's inputs, forming a branching directed graph (not a straight line); cyan bonds, dark void, 2.35:1",
    motionPrompt:
  ...
  },
  {
    ...
    layer: "quark",
    keyframePrompt:
      'A vertical transparent stack test-tube in a dark lab; particles labeled "Sig" and "PubKey" stacked inside; opcode operations shown as colliding particles; violet-magenta energy; a single green "TRUE" particle glowing at the top, 2.35:1',
    motionPrompt:
  ...
  },
  {
    ...
    layer: "quark",
    keyframePrompt:
      'Camera pulled back to show a whole transaction atom with multiple data surfaces glowing — "scriptPubKey", "OP_RETURN", "scriptSig", "witness", "Taproot script path", "coinbase input"; data particles approaching each surface; a translucent measuring grid labeled "BIP110" descending over all surfaces, 2.35:1',
    motionPrompt:
